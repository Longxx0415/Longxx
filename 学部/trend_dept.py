...
save_path_metrics = safe_save(test_summary, 'result_2030_metrics_trend_dept.csv')
save_path_26 = safe_save(result_26, 'result_2026_validation_trend_dept.csv')
save_path_30 = safe_save(result_30, 'result_2030_forecast_trend_dept.csv')
